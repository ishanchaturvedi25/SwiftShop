...
const Navbar = () => {
  ...
  const { setShowSearch, getCartCount, navigate, isAuthenticated } = useContext(ShopContext);
    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <div className='group relative'>
                <img onClick={() => isAuthenticated ? null : navigate('/login')} src={assets.profile_icon} className='w-5 cursor-pointer' alt="" />
