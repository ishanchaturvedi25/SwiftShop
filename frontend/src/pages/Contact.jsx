    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Tel: (+91) 9555-659-658 <br /> Email: ishanchaturvedi25@gmail.com</p>
          <p className='font-semibold text-xl text-gray-600'>Careers at SwiftShop</p>
